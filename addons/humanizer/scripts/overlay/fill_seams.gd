...
class_name HumanizerOverlayFillSeams
...
func get_texture_node(target_size:Vector2,mesh_arrays:Array): 
	...
	shader_material.shader = HumanizerResourceService.load_resource("res://addons/humanizer/scripts/overlay/fill_seams.gdshader") 
	shader_material.set_shader_parameter("margin",margin)
