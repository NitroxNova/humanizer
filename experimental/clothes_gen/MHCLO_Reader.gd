...
var delete_vertices : Array
var scale_config = {x={start=0,end=0,length=0},y={start=0,end=0,length=0},z={start=0,end=0,length=0}}
...
func _init(filename:String):
	...
	while file.get_position() < file.get_length():
		...
		if current_section == SECTION.header:
			...
			#print(line)
			#3751 - 3767 3773 - 3802 3837 - 3853 3855 - 3865 3871 3874 - 3882 3923 - 4792 6335 6390 6392 - 6414
